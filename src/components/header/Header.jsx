...
function Header() {
  return (
    ...
    <div style={{display: "flex", alignItems:"center"}}>
      ...
      <h6 style={{marginLeft: "-20px", marginTop: '7px', fontSize: '20px', color: 'rgb(1, 41, 112)', fontFamily: 'Roboto, sans-serif', fontWeight: '400' }}>
  ...
  <Dropdown.Toggle variant="default" id="dropdown-basic">
    <span style={{ color: '#012970', border: "none", borderStyle: "none" }} className="no-icon">
